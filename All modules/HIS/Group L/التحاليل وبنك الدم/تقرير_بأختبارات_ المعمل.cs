...
namespace HIS
{
    public partial class تقرير_بأختبارات__المعمل : Form
    {
        //SqlConnection connection = new SqlConnection("Data Source=peter-pc;Initial Catalog=PHIS;Integrated Security=True");
        SqlCommand cmd;
        SqlDataReader dr;
        public تقرير_بأختبارات__المعمل()
        {
            InitializeComponent();
        }

        private void تقرير_بأختبارات__المعمل_Load(object sender, EventArgs e)
        {
            ...
            SqlConnection connection = new SqlConnection(constr);
                 ...
                 //  cmd = new SqlCommand("select id,serv_name,price,quantity,notices from analysis_info", connection);
                   ...
                   cmd = new SqlCommand("labAnalysis_analysis_info_select7", connection);
