...
namespace HIS
{
    public partial class A_FRM_Patients_Category : Form
    {
        public A_FRM_Patients_Category()
        {
            InitializeComponent();
        }
        ...
        private void A_FRM_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                con.OpenConection();
                ds = con.select("select * from tb_Patients_Categories ;", "tb_Patients_Categories");
        ...
        private void C_Save_Click(object sender, EventArgs e)
        {
            ...
            if (check())
            {
                if (con.update(ds, "tb_Patients_Categories"))
                {
