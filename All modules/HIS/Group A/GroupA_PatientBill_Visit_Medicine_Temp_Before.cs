...
namespace HIS
{
    public partial class GroupA_PatientBill_Visit_Medicine_Temp_Before : UserControl
    {
        int User_ID;
        Connection conn;
        SqlDataReader dr;
        ...
        public GroupA_PatientBill_Visit_Medicine_Temp_Before(int uid)
        {
            InitializeComponent();
            conn = new Connection();
            User_ID = uid;
        ...
        private void calculate()
        {
            ...
            try
            {
                ...
                label2.Text = (Patient_medicine_percentage * total3 / 100).ToString();
            }
            catch (Exception ex)
            {
