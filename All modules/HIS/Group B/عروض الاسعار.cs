...
namespace HIS
{
    public partial class عروضالاسعار : Form
    {
        ...
        public عروضالاسعار()
        {
          ...
          public عروضالاسعار(عروضالاثمان f6)
        {
            InitializeComponent();
            c= f6;
        }
        ...
        private void Form39_Load(object sender, EventArgs e)
        {
            ...
            //da = new SqlDataAdapter("select * from price_offer;", @"Server=DEMIANA\SQLEXPRESS;Database=PHIS;integrated security=true");
