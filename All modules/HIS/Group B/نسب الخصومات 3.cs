...
namespace HIS
{
    public partial class For36 : Form
    {
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            c.setV(row.Cells[1].Value.ToString(), row.Cells[3].Value.ToString(), row.Cells[2].Value.ToString(), row.Cells[0].Value.ToString());
            this.Close();
        }
    }
}
