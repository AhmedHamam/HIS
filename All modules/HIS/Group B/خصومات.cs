...
namespace HIS
{
    public partial class For28 : Form
    {
        ...
        public For28( استمارهدفعلمورد f7)
        {
            InitializeComponent();
            c = f7;
        }
        ...
        private void Form28_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dataGridView1.DataSource = con.ShowDataInGridViewUsingStoredProc("showdiscound");
            }
            catch (Exception ex)
            {
            ...
            //SqlCommand cmd = new SqlCommand("showdiscound", con);
