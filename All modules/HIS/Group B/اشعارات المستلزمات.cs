...
namespace HIS
{
    public partial class For32 : Form
    {
                        ...
                        if (String.IsNullOrEmpty(textBox5.Text))
                        {
                            ...
                            if (textBox5.Text.Any(c => Char.IsLetter(c)))
                            {
                                ...
                                if (String.IsNullOrEmpty(textBox2.Text))
                                {
                                    ...
                                    {
                                        if (textBox8.Text == "نسبه واضافه" && textBox7.Text == "من 50 الي 250" || textBox8.Text == "نسبه واضافه" && textBox7.Text == "من 250الي 500" || textBox8.Text == "نسبه واضافه" && textBox7.Text == "من 500الي 1000" || textBox8.Text == "نسبه واضافه" && textBox7.Text == "من 1000الي 5000" || textBox8.Text == "نسبه واضافه" && textBox7.Text == "من 5000الي 10000")
                                        {
                                            double l = Double.Parse(textBox2.Text) / 100.0;
                                            double d = Double.Parse(textBox5.Text);
                                            double f = (l) * d;
                                            f = (f + 160) * 3;
                                            textBox3.Text = f.ToString();
                                            double q = Double.Parse(textBox3.Text) - Double.Parse(textBox5.Text);
