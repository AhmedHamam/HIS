...
namespace HIS
{
    public partial class Inpatientclaim : Form
    {
        DataTable dt;

        Connection con = new Connection();

        public Inpatientclaim()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
             try
            {
                ...
                else
                {
                        ...
                        dataGridView1.DataSource = con.ShowDataInGridViewUsingStoredProc("Inpatient_claim", pramname, pramvalue, pramtype);
                        //MessageBox.Show("");
                        con.CloseConnection();
