...
namespace HIS
{
    public partial class عملية_ادخال_مستندات_للموردين : Form
    {
        Connection con = new Connection();
        public عملية_ادخال_مستندات_للموردين(string value, string value2)
        {
            InitializeComponent();
            textBox2.Text = value;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    con.ExecuteInsertOrUpdateOrDeleteUsingStoredProc("insertdocumentforsup", s, s2, s3);
        ...
        private void عملية_ادخال_مستندات_للموردين_Load(object sender, EventArgs e)
        {
            try{
