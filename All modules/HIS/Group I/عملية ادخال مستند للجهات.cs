...
namespace HIS
{
    public partial class عملية_ادخال_مستند_للجهات : Form
    {
        Connection con = new Connection();
        public عملية_ادخال_مستند_للجهات(string value, string value2)
        {
            InitializeComponent();
            textBox2.Text = value;
        ...
        {   try{
             string x = "";
                ...
                if (dr.HasRows)
                {
                    ...
                    con.ExecuteInsertOrUpdateOrDeleteUsingStoredProc("insertdocumentforclint", s, s2, s3);
        ...
        private void عملية_ادخال_مستند_للجهات_Load(object sender, EventArgs e)
        {
            try
            {
