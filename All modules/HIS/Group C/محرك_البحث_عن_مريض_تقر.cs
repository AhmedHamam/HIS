...
namespace HIS
{
    public partial class محرك_البحث_عن_مريض_تقر : Form
    {
        ...
        int count2 = 0;
        int code1;
        تقرير_بيانات_المريض y=new تقرير_بيانات_المريض();
        public محرك_البحث_عن_مريض_تقر()
        {
            InitializeComponent();
        }
        public محرك_البحث_عن_مريض_تقر(تقرير_بيانات_المريض x)
        {
            InitializeComponent();
            y = x;
        }
        ...
        private void محرك_البحث_عن_مريض_تقرير_Load(object sender, EventArgs e)
        {
       ...
       /* private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
               ...
               string  code2 = this.dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString();
               MessageBox.Show(code2);
                تقرير_بيانات_المريض ff = new تقرير_بيانات_المريض();
