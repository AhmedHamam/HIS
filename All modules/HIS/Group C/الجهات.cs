...
namespace HIS
{
    ...
    public partial class الجهات00 : Form
    {
        ...
        public الجهات00(االغاء_تسجيل_مريض x) {

            InitializeComponent();
            y = x;

        }
        public الجهات00(البطاقة_العلاجية1 x)
        {
        ...
        private void الغاء_تسجيل_برامج_Load(object sender, EventArgs e)
        {
