...
namespace HIS
{
    public partial class عرض_بيانات_الموظفين6 : Form
    {
        Connection con=new Connection();
        public عرض_بيانات_الموظفين6()
        {
            InitializeComponent();
        }
        ...
        private void Form28_Click(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                اذونات_تأخير ff = new اذونات_تأخير(s2, s3, s4, s5, s6, s7, s8, s9);
                ff.Show();
                this.Close();
            }
            catch (Exception ex)
