...
namespace HIS
{
    public partial class مصادر_الدخول : Form
    {
        ...
        private void مصادر_الدخول_Load(object sender, EventArgs e)
        {
            con.OpenConection();
            dataGridView1.DataSource = (DataTable)con.ShowDataInGridViewUsingStoredProc("ent");
            con.CloseConnection();
        }
