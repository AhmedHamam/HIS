...
namespace HIS
{
    public partial class محرك_البحث_عن__مريض1 : Form
    {
        ...
        private void محرك_البحث_عن__مريض1_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            /*string b;
                ...
                string m = "select patient_name from Registeration_patientRegisteration where patient_id=@d";
                cmd2 = new MySqlCommand(m,con);
                cmd2.Parameters.AddWithValue("@d",id);
                b= cmd2.ExecuteScalar().ToString();*/
           
            // h = int.Parse(c);
            تعديل_بيانات_الاسم d = new تعديل_بيانات_الاسم(id);
