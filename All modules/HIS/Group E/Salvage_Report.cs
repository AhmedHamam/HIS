...
namespace HIS
{
    public partial class Salvage_Report : Form
    {
        public Salvage_Report()
        {
            InitializeComponent();
        }
        ...
        public void generate_reports()
        {
            ...
            try
            {
                ...
                object dt = sqlCon.ShowDataInGridViewUsingStoredProc("asset_sal_conditional_report", a, b, c);
        ...
        public void generate_reports1()
        {
            ...
            {
                sqlCon.OpenConection();
                object dt = sqlCon.ShowDataInGridViewUsingStoredProc("asset_sal_report");
                reportViewer1.LocalReport.DataSources.Clear();
                var rtds = new ReportDataSource("DataSet1", dt);
                reportViewer1.LocalReport.DataSources.Add(rtds);
                reportViewer1.RefreshReport();
