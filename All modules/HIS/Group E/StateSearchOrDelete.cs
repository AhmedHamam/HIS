...
namespace HIS
{
    public partial class StateSearchOrDelete : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                String[] b = { "asset_condition", "0", textBox2.Text, textBox3.Text, "0" };
                if (textBox1.Text != "")
                {
                    b[4] = "1";
                    b[1] = textBox1.Text;
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                String[] a = { "@t", "@c" };
                String[] b = { "asset_condition", dataGridView1.Rows[selectedrow].Cells[0].Value.ToString() };
        ...
        private void StateSearchOrDelete_Load(object sender, EventArgs e)
        {
