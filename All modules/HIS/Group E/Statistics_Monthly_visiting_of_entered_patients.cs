...
namespace HIS
{
    ...
    public partial class Statistics_Monthly_visiting_of_entered_patients : Form
    {
        Connection y = new Connection();
        public Statistics_Monthly_visiting_of_entered_patients()
        {
            InitializeComponent();
        }

        private void Statistics_Monthly_visiting_of_entered_patients_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                object dt = y.ShowDataInGridViewUsingStoredProc("sm", arr1, arr2, arr3);
